...
// Game icon - using public folder image
const gameIconUrl = "/kali_jotta_game_icon_with_marbles.png";
      ...
      <header className="fixed top-0 left-0 right-0 bg-[#0d0416]/85 backdrop-blur-lg z-50 border-b border-[#00D9FF]/20">
        <div className="flex justify-between items-center px-5 py-3">
          <div className="flex gap-2 items-center">
            ...
            >
              <img src={gameIconUrl} alt="Kanchey King" className="w-6 h-6 rounded-full" />
            </Button>
            {showBackButton && (
              <Button
                size="icon"
